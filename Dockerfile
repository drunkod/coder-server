# This is a hack for setting up alternative architecture names
...
FROM jrottenberg/ffmpeg:6.0-alpine AS linux-amd64
...
FROM jrottenberg/ffmpeg:6.0-alpine AS linux-arm64 
